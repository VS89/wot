...
use crate::external_api::base_api_client::{ApiError, BaseApiClient};
use crate::utils::{read_file_to_buffer, get_file_name, validate_zip_archive};
use super::models::project::Project;
use super::models::get_launch_by_id::GetLaunchByIdResponse;
...
impl TestopsApi {
    ...
    pub async fn post_upload_report(&self, file_path: &Path, launch_info: &LaunchInfo) -> Result<ResponseLaunchUpload, ApiError> {
        ...
        let _ = validate_zip_archive(&buffer)?;
