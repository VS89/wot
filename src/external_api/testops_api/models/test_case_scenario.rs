...
mod tests {
    ...
    fn create_test_scenario() -> Scenario {
        ...
        steps.insert("1".to_string(), ScenarioStep {
            id: 1,
        ...
        steps.insert("2".to_string(), ScenarioStep {
            id: 2,
        ...
        steps.insert("3".to_string(), ScenarioStep {
            id: 3,
    ...
    fn test_multiple_root_children() {
        ...
        scenario.scenario_steps.insert("4".to_string(), ScenarioStep {
            id: 4,
        ...
        scenario.scenario_steps.insert("5".to_string(), ScenarioStep {
            id: 5,
            body: "Expected Result".to_string(),
            expected_result_id: None,
            children: Some(vec![6]),
        ...
        scenario.scenario_steps.insert("6".to_string(), ScenarioStep {
            id: 6,
    ...
    fn test_missing_expected_result() {
        let mut scenario = create_test_scenario();
        scenario.scenario_steps.get_mut("1").unwrap().expected_result_id = None;
